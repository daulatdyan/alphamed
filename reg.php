...
<div id="header"></div>
	...
	<form id="regmng" name="regmng" class="desc" method="post" action="action.php">
        ...
        <tr>
        	<td>Username: </td>
        	<td><input type="text" id="username1" name="username1"  id="msg"></p></td>
        </tr>
        <tr>
        	<td>Password: </td>
        ...
        <tr>
        	<td>Gender: </td>
        	<td><input type="radio" id="gender1" name="gender1" checked="checked" value="male"/>Male
				<input type="radio" id="gender1" name="gender1" value="female" />Female</td>
        </tr>
        <tr>
        	<td>Date of Birth: </td>
        	<td><input type="date" id="dob1" name="dob1"></td>
        </tr>
        ...
        <tr>
        	<td>Mobile: </td>
        	<td><input type="text" id="mobile1" name="mobile1"></td>
        </tr>
        <tr>
        	<td>Email: </td>
        ...
        <tr>
        	<td  colspan="2"><center><input type="submit" id="register" name="register" value="Add Doctor"></center></td>
        </tr>
        </table>
    </form>
    ...
    <form id="regsup" name="regsup" class="desc"  style="display: none;" method="post" action="action.php">
        ...
        <tr>
        	<td>Username: </td>
        	<td><input type="text" id="username2" name="username2" </p></td>
        </tr>
        <tr>
        	<td>Password: </td>
		...
		<tr>
        	<td>Gender: </td>
        	<td><input type="radio" id="gender2" name="gender2" checked="checked" value="male"/>Male
				<input type="radio" id="gender2" name="gender2" value="female" />Female</td>
        </tr>
		<tr>
        	<td>Date of Birth: </td>
        	<td><input type="date" id="dob2" name="dob2"></td>
        </tr>
        ...
        <tr>
        	<td colspan="2"><center><input type="submit" id="register2" name="register2" value="Add Patient"></center></td>
        </tr>
        </table>
    </form>
...
$(document).ready(function(){ 
	...
	$("#regmng").validate({
                ...
                messages: {
                    ...
                    username1: "<br/><p class='warning'>Please enter your username</p>",
                    pass: {
     ...
     $("#regsup").validate({
                ...
                messages: {
                    ...
                    username3: "<br/><p class='warning'>Please enter your username</p>",
                    pass2: {
                        required: "<br/><p class='warning'>Please provide a password</p>",
